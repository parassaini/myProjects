...
(function () {
    ...
    var bgImage, brImage, br2Image, br3Image, br4Image,banImage,quImage, pl1Image, pl2Image, pl3Image, pl4Image, pl5Image, pl6Image, pl7Image, pl8Image, pl9Image, pl10Image, pl11Image, pl12Image, pl13Image, pl14Image, pl15Image, pl16Image, prImage;
    var brBitmap,br2Bitmap,br3Bitmap,br4Bitmap, bgBitmap,quBitmap,banBitmap, pl1Bitmap, pl2Bitmap, pl3Bitmap, pl4Bitmap, pl5Bitmap, pl6Bitmap, pl7Bitmap, pl8Bitmap, pl9Bitmap, pl10Bitmap, pl11Bitmap, pl12Bitmap, pl13Bitmap, pl14Bitmap, pl15Bitmap, pl16Bitmap, prBitmap;
    var queue;
    var playerX = 70;
    var playerY = 590;
    var KEYCODE_LEFT = 37;
...
queue.loadManifest([
            ...
            {id:"ban",src:"images/ban - Copy.png"},
           { id: "br", src: "images/br.jpg" },
            { id: "qu", src: "images/qu - Copy.jpg" },
            { id: "run", src: "jump.mp3" },
            {id:"clear",src:"castle_clear.mp3"}
]);
    ...
    function prepareResume() {
        ...
        banImage = queue.getResult("ban");
        banBitmap = new createjs.Bitmap(banImage).set({
            scaleX: 4,
            scaleY: 1,
            visible: true,
            x: 0,
        ...
        name = new createjs.Text("GAURAV YADAV", "15px Arial", "#ff7700").set({
            scaleX: 1,
            scaleY: 3,
            visible: false,
            x: 190,
        ...
        phone = new createjs.Text("9718819916", "15px Arial", "#ff7700").set({
            scaleX: 1,
            scaleY: 3,
            visible: false,
            x: 400,
        ...
        email = new createjs.Text("g.yadav21@gmail.com", "15px Arial", "#ff7700").set({
            scaleX: 1,
            scaleY: 3,
            visible: false,
            x: 500,
        ...
        quImage = queue.getResult("qu");
        quBitmap = new createjs.Bitmap(quImage).set({
            scaleX: 0.4,
            scaleY: 0.3,
            visible: true,
            x: 981,
        ...
        stage.addChild(quBitmap);
        addr = new createjs.Text("rz-45a/1 raj nagr-1 palam colony new delhi", "15px Arial", "#ff7700").set({
            scaleX: 1,
            scaleY: 3,
            visible: false,
            x: 900,
    ...
    function jump()
    {
        ...
        i = j;
        if (j == 1) {
            if ((playerX > 1000 && playerX < 1300)||(playerX>600&&playerX<750))
                k = 50;
            else
                k = 15;
        }
        ...
        if (playerX > 1200 && playerY < 500)
        {
            pl16Bitmap.y = pl15Bitmap.y = pl14Bitmap.y = pl13Bitmap.y = pl12Bitmap.y = pl11Bitmap.y = pl10Bitmap.y = pl9Bitmap.y = pl8Bitmap.y = pl7Bitmap.y = pl6Bitmap.y = pl5Bitmap.y = pl4Bitmap.y = pl3Bitmap.y = pl2Bitmap.y = pl1Bitmap.y = 470;
            pl16Bitmap.x = pl15Bitmap.x = pl14Bitmap.x = pl13Bitmap.x = pl12Bitmap.x = pl11Bitmap.x = pl10Bitmap.x = pl9Bitmap.x = pl8Bitmap.x = pl7Bitmap.x = pl6Bitmap.x = pl5Bitmap.x = pl4Bitmap.x = pl3Bitmap.x = pl2Bitmap.x = pl1Bitmap.x = 1260;
            run();k = 0;
            down();
        }
        jumpUp();
    ...
    function run()
    {
        ...
        if (p == 15||p==1) {
            ...
            var mySound = createjs.Sound.play("jump.mp3");
            p = 2;
        }
        p++;
        if (i == 10) {
    ...
    function draw() {
        brBitmap.visible = true;
        name.visible = true;
        stage.update();
    }
    function draw1() {
        br2Bitmap.visible = true;
        phone.visible = true;
        stage.update();
    }
    function draw2() {
        br3Bitmap.visible = true;
        email.visible = true;
        stage.update();
    }
    function draw3() {
        br4Bitmap.visible = true;
        quBitmap.visible = false;
        addr.visible = true;
        stage.update();
    }
